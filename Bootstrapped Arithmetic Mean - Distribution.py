...
print(f"Bootstrapped Mean Annualized Arithmetic Return: {corrected_mean_bootstrap_arithmean:.4f}")
print(f"95% Confidence Interval (Bias Corrected): ({lower_bound:.4f}, {upper_bound:.4f})")
